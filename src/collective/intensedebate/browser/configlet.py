...
class IIntenseDebateSettings(Interface):
    ...
    """
    forum_id = TextLine(
        title = _(u"IntenseDebate's 'idcomments_acct' string "),
        description = _(u"This string is used to uniquely identify your website on IntenseDebate. It typically looks like 'f4e4d39dhdl756bcd98refbl321fl8ar'. Copy that string and paste it in the field below. You need to enter this ID before you begin using IntenseDebate."),
        required = False
        )
...
class IntenseDebateControlPanel(ControlPanelForm):
    ...
    label = _(u"IntenseDebate Comment System")
