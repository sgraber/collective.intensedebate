...
class IIDMostPopularPortlet(IPortletDataProvider):
    """A portlet that displays the most popular content from Intense Debate.
...
class AddForm(base.AddForm):
    ...
    """
    form_fields = form.Fields(IIDMostPopularPortlet)
    
    label = _(u"Add Intense Debate Most Popular Content Portlet")
    description = _(u"This portlet displays a listing of your most popular content based on your Intense Debate comments.")
...
class EditForm(base.EditForm):
    ...
    label = _(u"Edit Intense Debate Most Popular Content Portlet")
    description = _(u"This portlet displays a listing of your most popular content based on your Intense Debate comments")
